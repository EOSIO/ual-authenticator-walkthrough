...
This tutorial walks through the steps required to create a [UAL](https://github.com/EOSIO/universal-authenticator-library) Ledger [Authenticator](https://github.com/EOSIO/universal-authenticator-library/blob/develop/src/Authenticator.ts). 
...
An `Authenticator` represents the bridge between [UAL](https://github.com/EOSIO/universal-authenticator-library)
